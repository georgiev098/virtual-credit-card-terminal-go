...
func (app *Application) SendEmail(from string, to string, subject string, tmpl string, attachments []string, data any) error {
	err := godotenv.Load()
	if err != nil {
	...
	smtpPortInt, _ := strconv.Atoi(os.Getenv("MAILTRAP_PORT"))
